...
<head>
    ...
    @if(get_option('language_direction', 'ltr') === 'rtl')
        <link href="https://fastly.jsdelivr.net/gh/RTLCSS/bootstrap@4.2.1-rtl/dist/css/rtl/bootstrap.min.css"
              rel="stylesheet">
    @else
        <link rel="stylesheet" href="https://fastly.jsdelivr.net/npm/bootstrap@4.3.1/dist/css/bootstrap.min.css">
    @endif
    <link rel="stylesheet" href="https://fastly.jsdelivr.net/npm/@fortawesome/fontawesome-free@5.11.2/css/all.min.css">
    ...
    <link rel="stylesheet" href="https://fastly.jsdelivr.net/npm/selection-sharer@1.1.0/dist/selection-sharer.css">
    <link
                        ...
                        @if($social['url'] && $social['icon'])
                            <li class="list-inline-item">
                                <a href="{{ url($social['url']) }}" class="{{ $social['icon'] }} fa-fw"
                                   title="{{ $social['name'] }}" target="_blank"></a>
                            </li>
                        @endif
                    @endforeach
                </ul>
    ...
    <div class="row">
        <div class="col-sm-3">
            ...
            <div class="member-menu list-group">
                ...
                <a href="{{ route('member.bookmarks.index') }}" class="list-group-item list-group-item-action">
                    <i class="fas fa-bookmark"></i> {{ __('My Bookmarks') }}
                </a>
                <a href="{{ route('member.likes.index') }}" class="list-group-item list-group-item-action">
                    <i class="far fa-thumbs-up"></i> {{ __('My Likes') }}
                </a>
...
<script src="https://fastly.jsdelivr.net/npm/bootstrap@4.3.1/dist/js/bootstrap.bundle.min.js"></script>
